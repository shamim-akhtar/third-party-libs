...
# osgViewer, a component library of OpenSceneGraph. This is designed to be used
...
foreach(dependency osgGA;osgText;osgDB;osgUtil)
    ...
    if(NOT EXISTS ${osg_component_dependency_target_file})
        ...
        message(FATAL_ERROR
          "Could not find [${dependency}] which is a dependency of [osgViewer]."
...
include(${CMAKE_CURRENT_LIST_DIR}/osgViewer-targets.cmake)
