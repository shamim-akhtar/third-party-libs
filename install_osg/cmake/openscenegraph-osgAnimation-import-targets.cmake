...
# osgAnimation, a component library of OpenSceneGraph. This is designed to be used
...
foreach(dependency osgText;osgGA;osgViewer)
    ...
    if(NOT EXISTS ${osg_component_dependency_target_file})
        ...
        message(FATAL_ERROR
          "Could not find [${dependency}] which is a dependency of [osgAnimation]."
...
include(${CMAKE_CURRENT_LIST_DIR}/osgAnimation-targets.cmake)
