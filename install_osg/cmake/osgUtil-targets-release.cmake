...
set_target_properties(osg3::osgUtil PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "osg3::osg;osg3::OpenThreads;opengl32"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/osg202-osgUtil.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS osg3::osgUtil )
list(APPEND _IMPORT_CHECK_FILES_FOR_osg3::osgUtil "${_IMPORT_PREFIX}/lib/osgUtil.lib" "${_IMPORT_PREFIX}/bin/osg202-osgUtil.dll" )
