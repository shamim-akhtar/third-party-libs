...
# osgManipulator, a component library of OpenSceneGraph. This is designed to be used
...
foreach(dependency osgViewer;osgGA;osgUtil)
    ...
    if(NOT EXISTS ${osg_component_dependency_target_file})
        ...
        message(FATAL_ERROR
          "Could not find [${dependency}] which is a dependency of [osgManipulator]."
...
include(${CMAKE_CURRENT_LIST_DIR}/osgManipulator-targets.cmake)
